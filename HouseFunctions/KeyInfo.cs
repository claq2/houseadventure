...
namespace HouseCore
{
    ...
    /// 
    /// </summary>
    public class KeyInfo : PortableObjectInfo
    {
        /// <summary>
        ...
        public KeyInfo(string name, string shortName, int initialRoom, Floor floor)
        ...
        public KeyInfo(string name, string shortName, int initialRoom, Floor floor, bool visible)
