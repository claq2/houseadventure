...
namespace UnitTests2
{
    ...
    public class Tests
    {
        ...
        [TestMethod]
        [ExpectedException(typeof(HouseCore.Exceptions.NullViewArgumentException), "The view's Argument property is null")]
        ...
        [TestMethod]
        public void IsPortableTest()
        {
            Assert.IsTrue(this.house.IsPortable("hai"));
            Assert.IsTrue(this.house.IsPortable("hairbrush"));
            Assert.IsFalse(this.house.IsPortable("a brass bathtub"));
        }
