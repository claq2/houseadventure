...
namespace HouseCore
{
    ...
    /// 
    /// </summary>
    public class BrushInfo : PortableObjectInfo
    {
        /// <summary>
        ...
        public BrushInfo(string name, string shortName, int initialRoom, Floor floor)
        ...
        public BrushInfo(string name, string shortName, int initialRoom, Floor floor, bool visible)
