...
namespace HouseCore
{
    ...
    /// 
    /// </summary>
    public class DiamondInfo : PortableObjectInfo
    {
        /// <summary>
        ...
        public DiamondInfo(string name, string shortName, int initialRoom, Floor floor)
        ...
        public DiamondInfo(string name, string shortName, int initialRoom, Floor floor, bool visible)
