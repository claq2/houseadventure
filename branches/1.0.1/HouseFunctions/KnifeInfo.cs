...
namespace HouseCore
{
    ...
    /// 
    /// </summary>
    public class KnifeInfo : PortableObjectInfo
    {
        /// <summary>
        ...
        public KnifeInfo(string name, string shortName, int initialRoom, Floor floor)
        ...
        public KnifeInfo(string name, string shortName, int initialRoom, Floor floor, bool visible)
