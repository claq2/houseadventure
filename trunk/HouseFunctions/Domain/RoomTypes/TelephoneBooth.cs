...
namespace HouseCore
{
    ...
    public class TelephoneBooth : Room
    {
        ...
        public TelephoneBooth(string name, LocationType location, ExitSetKeyedCollection exits, bool magic, MagicWord word)
        ...
        /// <param name="location">The location.</param>
        /// <param name="exits">The exits.</param>
        public TelephoneBooth(string name, LocationType location, ExitSetKeyedCollection exits)
